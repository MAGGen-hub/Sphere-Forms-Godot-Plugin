...
## Usualy meshes like Icosphere has "subdivisions" parameter that splits icosaedron triangle into [code]2^(subdivisions+1)[/code] triangles.[br][br]
## This parameter allow you to split icosaedron triangle into [code]edge_count^2[/code] triangles for better "customization".
